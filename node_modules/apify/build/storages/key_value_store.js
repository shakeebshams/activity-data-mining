...
const openKeyValueStore = async (storeIdOrName, options = {}) => {
    ...
    const manager = new storage_manager_1.StorageManager(KeyValueStore);
 ...
 * @function
 */
const getInput = async () => exports.getValue(process.env[consts_1.ENV_VARS.INPUT_KEY] || consts_1.KEY_VALUE_STORE_KEYS.INPUT);
