...
class Configuration {
    ...
    constructor(options = {}) {
        ...
        if (!this.get('localStorageDir') && !this.get('token')) {
            const dir = path_1.join(process.cwd(), './apify_storage');
    ...
    get(key, defaultValue) {
        var _a, _b;
        // prefer env vars
        const envKey = (_a = Configuration.ENV_MAP_REVERSED[key]) !== null && _a !== void 0 ? _a : key;
        ...
        return (_b = defaultValue !== null && defaultValue !== void 0 ? defaultValue : Configuration.DEFAULTS[key]) !== null && _b !== void 0 ? _b : envValue;
    }
    /**
     * @param {string} key
    ...
    getClient(options = {}) {
        var _a, _b;
        const baseUrl = (_a = options.baseUrl) !== null && _a !== void 0 ? _a : this.get('apiBaseUrl');
        const token = (_b = options.token) !== null && _b !== void 0 ? _b : this.get('token');
    ...
    getStorageLocal(options = {}) {
        var _a;
        const cacheKey = (_a = options.storageDir) !== null && _a !== void 0 ? _a : this.get('localStorageDir');
    ...
    createStorageLocal(options = {}) {
        var _a, _b;
        const storageDir = (_a = options.storageDir) !== null && _a !== void 0 ? _a : this.get('localStorageDir');
        const enableWalMode = (_b = options.enableWalMode) !== null && _b !== void 0 ? _b : this.get('localStorageEnableWalMode');
...
Configuration.ENV_MAP_REVERSED = Object.entries(Configuration.ENV_MAP).reduce((obj, [key, value]) => {
    obj[value] = key;
    return obj;
}, {});
Configuration.BOOLEAN_VARS = ['localStorageEnableWalMode'];
Configuration.INTEGER_VARS = ['proxyPort', 'memoryMbytes', 'containerPort'];
